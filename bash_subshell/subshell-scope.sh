...
#  Solution
#  --------
#  How about make it global, declare -x?

# TODO: How to make the ouside seen the var inside of the subshell?
#declare -x newvar=51
global newvar
newvar=51
( export newvar; let "newvar+=1"; echo "\$newvar INSIDE subshell = $newvar" )  # 52

echo "\$newvar OUTSIDE subshell = $newvar"                   # 51
